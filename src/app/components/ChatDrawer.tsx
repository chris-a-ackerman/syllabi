...
export function ChatDrawer({ open, onClose }: ChatDrawerProps) {
  const { chatMessages, addChatMessage, aiEnabled, semesters, currentChatId, submitFeedback } = useApp();
    ...
    <>
            ...
            <div className="border-t px-6 py-4">
              <div className="flex items-center gap-3">
                <Button
                  ...
                  className="shrink-0 rounded-full text-gray-400 hover:text-gray-600"
      ...
      <AlertDialog open={feedbackOpen} onOpenChange={setFeedbackOpen}>
        <AlertDialogContent className="rounded-2xl shadow-lg max-w-[510px]">
          ...
          <AlertDialogFooter>
            <AlertDialogCancel className="rounded-[10px] border border-black/10 text-[14px] font-medium">
              Cancel
            </AlertDialogCancel>
            <Button
