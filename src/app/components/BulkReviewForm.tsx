...
export function BulkReviewForm({
  ...
  const semesterGroups = fixedSemester
    ? detectedCourses.length > 0
      ? { __fixed__: detectedCourses }
      : {}
    : detectedCourses.reduce<Record<string, DetectedCourse[]>>((acc, dc) => {
        ...
        return (
          ...
          >
            ...
            <div
              className={
                compact
                  ? 'border-t border-gray-100 pt-3 space-y-3'
                  : 'border-t border-gray-100 pt-4 space-y-4'
              }
            >
              ...
              {groupCourses.map((dc) => (
                <div key={dc.id} className="space-y-2">
                  {dc.error && (
                    <Alert
                      className={`${compact ? 'py-1.5' : 'py-2'} bg-amber-50 border-amber-200`}
                    >
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div>
                      ...
                      <Input
                        value={dc.courseName}
                        onChange={(e) =>
                          updateDetectedCourse(dc.id, { courseName: e.target.value })
                        }
                    ...
                    <div>
                      ...
                      <Input
                        value={dc.courseCode}
                        onChange={(e) =>
                          updateDetectedCourse(dc.id, { courseCode: e.target.value })
                        }
